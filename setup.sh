...
# Function to encrypt configuration files
encrypt_config() {
...
# Function to encrypt a single configuration file
...
decrypt_config() {
    ...
    # List available encrypted configuration files
...
# Function to decrypt a single configuration file
decrypt_single_config() {
    ...
    if [ $? -eq 0 ]; then
        echo -e "${GREEN}Successfully decrypted to $(basename "$decrypted_file")${NC}"
